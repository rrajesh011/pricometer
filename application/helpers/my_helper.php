...
function get_button($status)
{
    $CI =& get_instance();
    if ($status == 1) {
        return '<span class="label label-pill label-success">' . $CI->lang->line('text_enabled') . '</span>';
    }
    return '<span class="label label-pill label-danger">' . $CI->lang->line('text_disabled') . '</span>';
}
