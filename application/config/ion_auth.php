...
$config['tables']['users_groups']    = 'users_groups_map';
...
/*
 ...
 |
 | If you are using Bcrypt the Admin password field also needs to be changed in order login as backend:
 ...
 */
$config['site_title']           = "Pricometer.com"; 		// Site Title, example.com
$config['admin_email']          = "rajesh@pricometer.com"; 	// Admin Email, backend@example.com
