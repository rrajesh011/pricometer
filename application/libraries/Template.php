...
class Template
{
	...
	function __construct($config = array())
	{
            ...
            $config['layout'] = $this->_ci->config->item('layout');
            $config['template_path'] = $this->_ci->config->item('template_path');
	...
	private function _find_view_folder()
	{
		...
		// Base view folder
		$view_folder = APPPATH.$this->_template_path;
		...
		// Things like views/backend/web/view backend = subdir
