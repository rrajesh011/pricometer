    ...
    var t = {
        detectionDivs: {
            ...
            e(document).ready(function () {
                e.each(i.breakpoints, function (e) {
                    i.breakpoints[e].appendTo(".responsive-bootstrap-toolkit")
                })
            })
        }, isAnExpression: function (e) {
            return "<" == e.charAt(0) || ">" == e.charAt(0)
        }, splitExpression: function (e) {
            var t = e.charAt(0), i = "=" == e.charAt(1), n = 1 + (i ? 1 : 0), o = e.slice(n);
            return {operator: t, orEqual: i, breakpointName: o}
        }, isAnyActive: function (t) {
            var n = !1;
            return e.each(t, function (e, t) {
                return i.breakpoints[t].is(":visible") ? (n = !0, !1) : void 0
            }), n
        }, isMatchingExpression: function (e) {
            var n = t.splitExpression(e), o = Object.keys(i.breakpoints), s = o.indexOf(n.breakpointName);
            if (-1 !== s) {
                var r = 0, a = 0;
        ...
        interval: 300, framework: null, breakpoints: null, is: function (e) {
            return t.isAnExpression(e) ? t.isMatchingExpression(e) : i.breakpoints[e] && i.breakpoints[e].is(":visible")
        }, use: function (e, n) {
            i.framework = e.toLowerCase(), i.breakpoints = "bootstrap" === i.framework || "foundation" === i.framework ? t.detectionDivs[i.framework] : n, t.applyDetectionDivs()
        }, current: function () {
            var t = "unrecognized";
            return e.each(i.breakpoints, function (e) {
                i.is(e) && (t = e)
            }), t
...
!function (e) {
    e.fn.clickoutside = function (e) {
        var t = 1, i = $(this);
        return i.cb = e, this.click(function () {
            t = 0
    ...
    function t(t) {
        var r = t || window.event, a = l.call(arguments, 1), c = 0, d = 0, p = 0, f = 0, h = 0, v = 0;
        if (t = e.event.fix(r), t.type = "mousewheel", "detail" in r && (p = -1 * r.detail), "wheelDelta" in r && (p = r.wheelDelta), "wheelDeltaY" in r && (p = r.wheelDeltaY), "wheelDeltaX" in r && (d = -1 * r.wheelDeltaX), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (d = -1 * p, p = 0), c = 0 === p ? d : p, "deltaY" in r && (p = -1 * r.deltaY, c = p), "deltaX" in r && (d = r.deltaX, 0 === p && (c = -1 * d)), 0 !== p || 0 !== d) {
            ...
            if (f = Math.max(Math.abs(p), Math.abs(d)), (!s || s > f) && (s = f, n(r, f) && (s /= 40)), n(r, f) && (c /= 40, d /= 40, p /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / s), d = Math[d >= 1 ? "floor" : "ceil"](d / s), p = Math[p >= 1 ? "floor" : "ceil"](p / s), u.settings.normalizeOffset && this.getBoundingClientRect) {
    ...
    e.fn.jScrollPane = function (t) {
        function i(t, i) {
            function n(i) {
                var s, a, c, u, d, h, v = !1, g = !1;
                if (I = i, void 0 === L)d = t.scrollTop(), h = t.scrollLeft(), t.css({
                    overflow: "hidden",
                    padding: 0
                }), O = t.innerWidth() + me, q = t.innerHeight(), t.width(O), L = e('<div class="jspPane" />').css("padding", ge).append(t.children()), F = e('<div class="jspContainer" />').css({
                    width: O + "px",
                    height: q + "px"
                }).append(L).appendTo(t); else {
                    if (t.css("width", ""), v = I.stickToBottom && C(), g = I.stickToRight && B(), u = t.innerWidth() + me != O || t.outerHeight() != q, u && (O = t.innerWidth() + me, q = t.innerHeight(), F.css({
                            width: O + "px",
                            height: q + "px"
                        })), !u && je == N && L.outerHeight() == V)return void t.width(O);
                ...
                L.css("overflow", "auto"), N = i.contentWidth ? i.contentWidth : L[0].scrollWidth, V = L[0].scrollHeight, L.css("overflow", ""), G = N / O, Q = V / q, $ = Q > 1, K = G > 1, K || $ ? (t.addClass("jspScrollable"), s = I.maintainPosition && (_ || te), s && (a = D(), c = T()), o(), r(), l(), s && (y(g ? N - O : a, !1), k(v ? V - q : c, !1)), S(), A(), E(), I.enableKeyboardNavigation && Y(), I.clickOnTrack && p(), z(), I.hijackInternalLinks && W()) : (t.removeClass("jspScrollable"), L.css({
                    ...
                    left: 0,
                    width: F.width() - me
                }), H(), P(), X(), f()), I.autoReinitialise && !ve ? ve = setInterval(function () {
                    n(I)
                }, I.autoReinitialiseDelay) : !I.autoReinitialise && ve && clearInterval(ve), d && t.scrollTop(0) && k(d, !1), h && t.scrollLeft(0) && y(h, !1), t.trigger("jsp-initialised", [K || $])
            }
            ...
            function o() {
                $ && (F.append(e('<div class="jspVerticalBar" />').append(e('<div class="jspCap jspCapTop" />'), e('<div class="jspTrack" />').append(e('<div class="jspDrag" />').append(e('<div class="jspDragTop" />'), e('<div class="jspDragBottom" />'))), e('<div class="jspCap jspCapBottom" />'))), ie = F.find(">.jspVerticalBar"), ne = ie.find(">.jspTrack"), U = ne.find(">.jspDrag"), I.showArrows && (ae = e('<a class="jspArrow jspArrowUp" />').bind("mousedown.html", u(0, -1)).bind("click.html", M), le = e('<a class="jspArrow jspArrowDown" />').bind("mousedown.html", u(0, 1)).bind("click.html", M), I.arrowScrollOnHover && (ae.bind("mouseover.html", u(0, -1, ae)), le.bind("mouseover.html", u(0, 1, le))), c(ne, I.verticalArrowPositions, ae, le)), se = q, F.find(">.jspVerticalBar>.jspCap:visible,>.jspVerticalBar>.jspArrow").each(function () {
                    ...
                    e("html").bind("dragstart.jsp%20selectstart.html", M), U.addClass("jspActive");
                    var i = t.pageY - U.position().top;
                    return e("html").bind("mousemove.html", function (e) {
                        v(e.pageY - i, !1)
                    }).bind("mouseup.jsp%20mouseleave.html", h), !1
                }), s())
            }

            function s() {
                ne.height(se + "px"), _ = 0, oe = I.verticalGutter + ne.outerWidth(), L.width(O - oe - me);
                try {
                    0 === ie.position().left && L.css("margin-left", oe + "px")
                } catch (e) {
                }
            }

            function r() {
                K && (F.append(e('<div class="jspHorizontalBar" />').append(e('<div class="jspCap jspCapLeft" />'), e('<div class="jspTrack" />').append(e('<div class="jspDrag" />').append(e('<div class="jspDragLeft" />'), e('<div class="jspDragRight" />'))), e('<div class="jspCap jspCapRight" />'))), ce = F.find(">.jspHorizontalBar"), ue = ce.find(">.jspTrack"), J = ue.find(">.jspDrag"), I.showArrows && (fe = e('<a class="jspArrow jspArrowLeft" />').bind("mousedown.html", u(-1, 0)).bind("click.html", M), he = e('<a class="jspArrow jspArrowRight" />').bind("mousedown.html", u(1, 0)).bind("click.html", M), I.arrowScrollOnHover && (fe.bind("mouseover.html", u(-1, 0, fe)), he.bind("mouseover.html", u(1, 0, he))), c(ue, I.horizontalArrowPositions, fe, he)), J.hover(function () {
                    J.addClass("jspHover")
                }, function () {
                    J.removeClass("jspHover")
                }).bind("mousedown.html", function (t) {
                    e("html").bind("dragstart.jsp%20selectstart.html", M), J.addClass("jspActive");
            ...
            function l() {
                if (K && $) {
                    var t = ue.outerHeight(), i = ne.outerWidth();
                    se -= t, e(ce).find(">.jspCap:visible,>.jspArrow").each(function () {
                        de += e(this).outerWidth()
                    }), de -= i, q -= i, O -= t, ue.parent().append(e('<div class="jspCorner" />').css("width", t + "px")), s(), a()
                }
            ...
            function u(e, t, i) {
                return function () {
                    return d(e, t, this, i), this.blur(), !1
                }
            }

            function d(t, i, n, o) {
                n = e(n).addClass("jspActive");
                var s, r, a = !0, l = function () {
                    0 !== t && be.scrollByX(t * I.arrowButtonSpeed), 0 !== i && be.scrollByY(i * I.arrowButtonSpeed), r = setTimeout(l, a ? I.initialDelay : I.arrowRepeatFreq), a = !1
                };
            ...
            function p() {
                f(), $ && ne.bind("mousedown.html", function (t) {
                    if (void 0 === t.originalTarget || t.originalTarget == t.currentTarget) {
                        var i, n = e(this), o = n.offset(), s = t.pageY - o.top - _, r = !0, a = function () {
                            var e = n.offset(), o = t.pageY - e.top - re / 2, c = q * I.scrollPagePercent, u = Z * c / (V - q);
                            if (0 > s)_ - u > o ? be.scrollByY(-c) : v(o); else {
                                if (!(s > 0))return void l();
                                o > _ + u ? be.scrollByY(c) : v(o)
                            }
                            i = setTimeout(a, r ? I.initialDelay : I.trackClickRepeatFreq), r = !1
                        }, l = function () {
                            i && clearTimeout(i), i = null, e(document).unbind("mouseup.html", l)
                        };
                        return a(), e(document).bind("mouseup.html", l), !1
                    }
                }), K && ue.bind("mousedown.html", function (t) {
                    if (void 0 === t.originalTarget || t.originalTarget == t.currentTarget) {
                        var i, n = e(this), o = n.offset(), s = t.pageX - o.left - te, r = !0, a = function () {
                            var e = n.offset(), o = t.pageX - e.left - pe / 2, c = O * I.scrollPagePercent, u = ee * c / (N - O);
                            if (0 > s)te - u > o ? be.scrollByX(-c) : m(o); else {
                                if (!(s > 0))return void l();
            ...
            function f() {
                ue && ue.unbind("mousedown.html"), ne && ne.unbind("mousedown.html")
            }

            function h() {
                e("html").unbind("dragstart.jsp%20selectstart.jsp%20mousemove.jsp%20mouseup.jsp%20mouseleave.html"), U && U.removeClass("jspActive"), J && J.removeClass("jspActive")
            }
            ...
            function v(i, n) {
                if ($) {
                    ...
                    if (t.trigger(o, [i]), !o.isDefaultPrevented()) {
                        var s = i || 0, r = 0 === s, a = s == Z, l = i / Z, c = -l * (V - q);
                        void 0 === n && (n = I.animateScroll), n ? be.animate(U, "top", i, g, function () {
                            t.trigger("jsp-user-scroll-y", [-c, r, a])
                        }) : (U.css("top", i), g(i), t.trigger("jsp-user-scroll-y", [-c, r, a]))
                    }
                }
            }
            ...
            function m(i, n) {
                if (K) {
                    ...
                    if (t.trigger(o, [i]), !o.isDefaultPrevented()) {
                        var s = i || 0, r = 0 === s, a = s == ee, l = i / ee, c = -l * (N - O);
                        void 0 === n && (n = I.animateScroll), n ? be.animate(J, "left", i, j, function () {
                            t.trigger("jsp-user-scroll-x", [-c, r, a])
                        }) : (J.css("left", i), j(i), t.trigger("jsp-user-scroll-x", [-c, r, a]))
                    }
                }
            }
            ...
            function j(e) {
                ...
                var i = 0 === te, n = te == ee, o = e / ee, s = -o * (N - O);
            ...
            function b(e, t) {
                I.showArrows && (ae[e ? "addClass" : "removeClass"]("jspDisabled"), le[t ? "addClass" : "removeClass"]("jspDisabled"))
            }

            function w(e, t) {
                I.showArrows && (fe[e ? "addClass" : "removeClass"]("jspDisabled"), he[t ? "addClass" : "removeClass"]("jspDisabled"))
            }
            ...
            function x(t, i, n) {
                var o, s, r, a, l, c, u, d, p, f = 0, h = 0;
                try {
                    o = e(t)
                } catch (v) {
                    return
                }
                for (s = o.outerHeight(), r = o.outerWidth(), F.scrollTop(0), F.scrollLeft(0); !o.is(".jspPane");)if (f += o.position().top, h += o.position().left, o = o.offsetParent(), /^body|html$/i.test(o[0].nodeName))return;
            ...
            function A() {
                F.unbind(Te).bind(Te, function (e, t, i, n) {
                    te || (te = 0), _ || (_ = 0);
                    var o = te, s = _, r = e.deltaFactor || I.mouseWheelSpeed;
            ...
            function S() {
                L.find(":input,a").unbind("focus.html").bind("focus.html", function (e) {
                    x(e.target, !1)
                })
            }

            function P() {
                L.find(":input,a").unbind("focus.html")
            }
            ...
            function Y() {
                ...
                var n, o, s = [];
                K && s.push(ce[0]), $ && s.push(ie[0]), L.bind("focus.html", function () {
                    t.focus()
                }), t.attr("tabindex", 0).unbind("keydown.jsp%20keypress.html").bind("keydown.html", function (t) {
                ...
                }).bind("keypress.html", function (t) {
                    return t.keyCode == n && i(), t.target === this || s.length && e(t.target).closest(s).length ? !o : void 0
                }), I.hideFocus ? (t.css("outline", "none"), "hideFocus" in F[0] && t.attr("hideFocus", !0)) : (t.css("outline", ""), "hideFocus" in F[0] && t.attr("hideFocus", !1))
            }

            function X() {
                t.attr("tabindex", "-1").removeAttr("tabindex").unbind("keydown.jsp%20keypress.html"), L.unbind(".jsp")
            }
            ...
            function z() {
                if (location.hash && location.hash.length > 1) {
                    ...
                    t.length && L.find(n) && (0 === F.scrollTop() ? i = setInterval(function () {
                        F.scrollTop() > 0 && (x(t, !0), e(document).scrollTop(F.position().top), clearInterval(i))
                    }, 50) : (x(t, !0), e(document).scrollTop(F.position().top)))
                }
            }

            function W() {
                e(document.body).data("jspHijack") || (e(document.body).data("jspHijack", !0), e(document.body).delegate('a[href*="#"]', "click", function (t) {
                    var i, n, o, s, r, a, l = this.href.substr(0, this.href.indexOf("#")), c = location.href;
            ...
            function E() {
                var e, t, i, n, o, s = !1;
                F.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.html", function (r) {
                    var a = r.originalEvent.touches[0];
                    e = D(), t = T(), i = a.pageX, n = a.pageY, o = !1, s = !0
                }).bind("touchmove.html", function (r) {
                    if (s) {
                        var a = r.originalEvent.touches[0], l = te, c = _;
            ...
            var I, L, O, q, F, N, V, G, Q, $, K, U, Z, _, J, ee, te, ie, ne, oe, se, re, ae, le, ce, ue, de, pe, fe, he, ve, ge, me, je, be = this, we = !0, ke = !0, ye = !1, xe = !1, De = t.clone(!1, !1).empty(), Te = e.fn.mwheelIntent ? "mwheelIntent.jsp" : "mousewheel.jsp";
            "border-box" === t.css("box-sizing") ? (ge = 0, me = 0) : (ge = t.css("paddingTop") + " " + t.css("paddingRight") + " " + t.css("paddingBottom") + " " + t.css("paddingLeft"), me = (parseInt(t.css("paddingLeft"), 10) || 0) + (parseInt(t.css("paddingRight"), 10) || 0)), e.extend(be, {
                reinitialise: function (t) {
                    ...
                    be.scrollByX(e, i), be.scrollByY(t, i)
                }, scrollByX: function (e, t) {
                    var i = D() + Math[0 > e ? "floor" : "ceil"](e), n = i / (N - O);
                    m(n * ee, t)
                }, scrollByY: function (e, t) {
                    var i = T() + Math[0 > e ? "floor" : "ceil"](e), n = i / (V - q);
                    v(n * Z, t)
